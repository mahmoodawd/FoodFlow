package com.example.foodflow.meals_by_category.view;
...
public class CategoryMealsFragment extends Fragment implements MealsViewInterface, OnThumbnailClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        categoryTitle = view.findViewById(R.id.categoryTitleHeader);
        ...
        String title = CategoryMealsFragmentArgs.fromBundle(getArguments()).getCategoryTitle();
        categoryTitle.setText(title);
        mealsPresenter.getMealsByCategory(title);
        return view;
    }

    private void showMealDetails(View view, String mealId) {
        CategoryMealsFragmentDirections.ActionCategoryMealsFragmentToMealDetailsFragment action = CategoryMealsFragmentDirections
